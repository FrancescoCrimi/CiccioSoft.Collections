...
namespace CiccioSoft.Collections.Ciccio
{
    ...
    public class ReadOnlyCiccioList<T> : ReadOnlyCollection<T>, INotifyCollectionChanged, INotifyPropertyChanged, IBindingList, IRaiseItemChangedEvents
    {
        #region Constructors

        /// <summary>
        /// Initializes a new instance of ReadOnlyCiccioList that
        /// wraps the given CiccioList.
        /// </summary>
