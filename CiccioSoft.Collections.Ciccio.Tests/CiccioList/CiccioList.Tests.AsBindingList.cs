...
namespace CiccioSoft.Collections.Ciccio.Tests
{
    public class CiccioList_As_BindingList
    {
        [Fact]
        public void Ctor_Default()
        {
            var list = new CiccioList<string>();
        ...
        public void Ctor_FixedSizeIList()
        {
            ...
            var bindingList = new CiccioList<string>(array);
        ...
        public void Ctor_NonFixedSizeIList()
        {
            ...
            var bindingList = new CiccioList<string>(list);
            IBindingList iBindingList = bindingList;
        ...
        public void RemoveAt_Invoke_CallsListChanged()
        {
            ...
            var bindingList = new CiccioList<object>(list);
        ...
        {
            var bindingList = new CiccioList<object> { new object(), new object() };
        ...
        public void Clear_INotifyPropertyChangedItems_RemovesPropertyChangedEventHandlers()
        {
            ...
            var bindingList = new CiccioList<Item>(list);
        ...
        {
            var item = new Item();
            var bindingList = new CiccioList<Item> { item };
        ...
        {
            var bindingList = new CiccioList<int> { 1 };
        ...
        public void ItemSet_INotifyPropertyChangedItem_RemovesPropertyChangedEventHandlers()
        {
            var item1 = new Item();
            var item2 = new Item();
            var bindingList = new CiccioList<Item> { item1 };
            Assert.Equal(1, item1.InvocationList.Length);
        ...
        {
            IBindingList bindingList = new CiccioList<object>();
