...
namespace CiccioSoft.Collections
{
    ...
    public class BindingHashSet<T> : ISet<T>/*, IBindingList, IRaiseItemChangedEvents*/, IReadOnlyCollection<T>
    {
        private HashSet<T> _set;

        /// <summary>
        ///     Initializes a new instance of the <see cref="BindingHashSet{T}" /> class
        ///     that is empty and uses the default equality comparer for the set type.
        /// </summary>
        public BindingHashSet()
        ...
        /// </param>
        public BindingHashSet(IEqualityComparer<T> comparer)
        {
        ...
        public BindingHashSet(IEnumerable<T> collection)
        ...
        ///     implementation for the set type.
        /// </param>
        public BindingHashSet(IEnumerable<T> collection, IEqualityComparer<T> comparer)
        {
