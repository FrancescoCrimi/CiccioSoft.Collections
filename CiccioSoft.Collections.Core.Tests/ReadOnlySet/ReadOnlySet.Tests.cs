...
namespace CiccioSoft.Collections.Core.Tests
{
    public class ReadOnlySet_Tests
    {
        ...
        {
            var set = new GenericHashSet<int>();
        ...
        {
            var set = new ReadOnlySet<int>(new GenericHashSet<int>() { 1, 2, 3 });
        ...
        {
            var set = new GenericHashSet<int> { 1, 2, 3 };
        ...
        {
            public DerivedReadOnlySet(GenericHashSet<T> set) : base(set) { }
