...
namespace CiccioSoft.Collections.Core.Tests
{
    ...
    public abstract class HashSet_Generic_Tests<T> : ISet_Generic_Tests<T>
    {
        ...
        {
            GenericHashSet<T> set = new GenericHashSet<T>();
            Assert.Empty(set);
        }
        ...
        public void HashSet_Generic_Constructor_IEqualityComparer()
        {
            ...
            GenericHashSet<T> set = new GenericHashSet<T>(comparer);
            if (comparer == null)
        ...
        public void HashSet_Generic_Constructor_IEnumerable(EnumerableType enumerableType, int setLength, int enumerableLength, int numberOfMatchingElements, int numberOfDuplicateElements)
        {
            ...
            GenericHashSet<T> set = new GenericHashSet<T>(enumerable);
        ...
        public void HashSet_Generic_Constructor_IEnumerable_WithManyDuplicates(int count)
        {
            ...
            GenericHashSet<T> hashSetFromDuplicates = new GenericHashSet<T>(Enumerable.Range(0, 40).SelectMany(i => items).ToArray());
            GenericHashSet<T> hashSetFromNoDuplicates = new GenericHashSet<T>(items);
        ...
        {
            GenericHashSet<T> source = new GenericHashSet<T>(CreateEnumerable(EnumerableType.HashSet, null, count, 0, 0));
            ...
            GenericHashSet<T> set = new GenericHashSet<T>(source, base.GetIEqualityComparer());
        ...
        {
            Assert.Throws<ArgumentNullException>(() => new GenericHashSet<T>((IEnumerable<T>)null));
            Assert.Throws<ArgumentNullException>(() => new GenericHashSet<T>((IEnumerable<T>)null, EqualityComparer<T>.Default));
        }
        ...
        public void HashSet_Generic_Constructor_IEnumerable_IEqualityComparer(EnumerableType enumerableType, int setLength, int enumerableLength, int numberOfMatchingElements, int numberOfDuplicateElements)
        {
            ...
            GenericHashSet<T> set = new GenericHashSet<T>(enumerable, base.GetIEqualityComparer());
            Assert.True(set.SetEquals(enumerable));
        }
        ...
        public void SetComparer_SetEqualsTests()
        {
            ...
            var set = new GenericHashSet<System.Collections.Generic.HashSet<T>>()
            {
            ...
            var noComparerSet = new GenericHashSet<System.Collections.Generic.HashSet<T>>()
            {
                new System.Collections.Generic.HashSet<T> { objects[0], objects[1], objects[2] },
                new System.Collections.Generic.HashSet<T> { objects[3], objects[4], objects[5] }
            };

            var comparerSet1 = new GenericHashSet<System.Collections.Generic.HashSet<T>>(System.Collections.Generic.HashSet<T>.CreateSetComparer())
            {
                new System.Collections.Generic.HashSet<T> { objects[0], objects[1], objects[2] },
                new System.Collections.Generic.HashSet<T> { objects[3], objects[4], objects[5] }
            };

            var comparerSet2 = new GenericHashSet<System.Collections.Generic.HashSet<T>>(System.Collections.Generic.HashSet<T>.CreateSetComparer())
            {
                new System.Collections.Generic.HashSet<T> { objects[3], objects[4], objects[5] },
                new System.Collections.Generic.HashSet<T> { objects[0], objects[1], objects[2] }
            };
        ...
        public void SetComparer_SequenceEqualTests()
        {
            ...
            var comparerSet = new GenericHashSet<System.Collections.Generic.HashSet<T>>(System.Collections.Generic.HashSet<T>.CreateSetComparer())
            {
                new System.Collections.Generic.HashSet<T> { objects[0], objects[1], objects[2] },
                new System.Collections.Generic.HashSet<T> { objects[3], objects[4], objects[5] }
            };
        ...
        {
            GenericHashSet<T> set = new GenericHashSet<T>(capacity);
            Assert.Equal(0, set.Count);
        }
        ...
        public void HashSet_Generic_Constructor_Capacity_ToNextPrimeNumber()
        {
            ...
            var set = new GenericHashSet<T>(Capacity);
        ...
        {
            AssertExtensions.Throws<ArgumentOutOfRangeException>("capacity", () => new GenericHashSet<T>(-1));
            AssertExtensions.Throws<ArgumentOutOfRangeException>("capacity", () => new GenericHashSet<T>(int.MinValue));
        }
        ...
        {
            IEqualityComparer<T> comparer = GetIEqualityComparer();
            GenericHashSet<T> set = new GenericHashSet<T>(capacity, comparer);
            Assert.Equal(0, set.Count);
            if (comparer == null)
                Assert.Equal(EqualityComparer<T>.Default, set.Comparer);
            else
        ...
        {
            IEqualityComparer<T> comparer = GetIEqualityComparer();
            AssertExtensions.Throws<ArgumentOutOfRangeException>("capacity", () => new GenericHashSet<T>(-1, comparer));
            AssertExtensions.Throws<ArgumentOutOfRangeException>("capacity", () => new GenericHashSet<T>(int.MinValue, comparer));
        }
        ...
        public void Remove_NonDefaultComparer_ComparerUsed(int capacity)
        {
            ...
            var set = new GenericHashSet<T>(capacity, c);
