...
{
    public partial class CiccioSet_Serialization
    {
        public static IEnumerable<object[]> SerializeDeserialize_Roundtrips_MemberData()
        {
            yield return new object[] { new CiccioSet<int>() };
            yield return new object[] { new CiccioSet<int>() { 42 } };
            yield return new object[] { new CiccioSet<int>() { 1, 5, 3, 4, 2 } };
        }
