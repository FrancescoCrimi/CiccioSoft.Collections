...
namespace CiccioSoft.Collections.Generic.Test.ObservableSet
{
    ...
    public partial class ConstructorAndPropertyTests
    {
        ...
        {
            var col = new ObservableSet<string>();
        ...
        {
            var actual = new ObservableSet<string>(collection);
        ...
        {
            var col = new ObservableSet<string>(new string[] { });
            Assert.Equal(0, col.Count);
            Assert.Empty(col);
        }
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("collection", () => new ObservableSet<string>((IEnumerable<string>)null));
        }
        ...
        //{
        //    var col = new ObservableSet<Guid>(new[] { Guid.NewGuid(), Guid.NewGuid(), Guid.NewGuid() });
        ...
        //{
        //    var col = new ObservableSet<int>(new int[size]);
        ...
        {
            ObservableSet<int> col = new ObservableSet<int>(new[] {1, 2, 3, 4});
        ...
        private partial class ObservableCollectionSubclass<T> : ObservableSet<T>
        {
        ...
        {
            AssertExtensions.Throws<ArgumentNullException>("collection", () => new ObservableSet<string>((List<string>)null));
        }
